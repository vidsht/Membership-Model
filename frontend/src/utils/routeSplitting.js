...
const EagerComponents = {
  ...
  // MembershipCard: React.lazy(() => import('../components/MembershipCard.jsx')), // Removed - statically imported in Dashboard
  ...
  // MerchantDashboard: React.lazy(() => import('../pages/MerchantDashboard.jsx')), // Removed - statically imported as critical component
